...
const NewsItems = (props) => {
    ...
    return (
        <div className="card" style={styleCss}>
            <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger bg-gradient p-2 fs-3">
                <span className="visually-hidden">{!Author ? "unknown" : Author }</span>
            </span>
            ...
            <div className="card-body">
                ...
                <p className="card-text">{new Date(DateAndTime).toGMTString()}</p>
